...
//        assertThat(allFetchTransactions.getFirst().getSenderAccountNumber()).isEqualTo(SENDER_ACCOUNT_NUMBER);
//
...
//
//        // Bank check
//        assertThat(allFetchTransactions.getFirst().getSenderBank().getBankCode()).isEqualTo(SENDER_BANK_CODE);
//        assertThat(allFetchTransactions.getLast().getSenderBank().getBankCode()).isEqualTo(SENDER_ACCOUNT_NUMBER);
//    }
//
//    @Test
