...
public class UserService{
    ...
    public UserResponse registerUser(UserRequest request) {
        ...
        return buildUserResponse(savedUser.getUsername(), savedUser.getRole().name());
    }
    ...
    public UserResponse verifyUserOnLogin(UserRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            {
                log.warn("[WARN] User is not a manager or analyst: {}", authenticated.getUsername());
                throw new InvalidCredentialException("User is not based on designated roles for this resource");
            }
            ...
            ResponseCookie newCookie = ResponseCookie.from(cookieName, token)
    ...
    public UserResponse logoutUser(HttpServletResponse response) {
        ...
        SecurityContextHolder.clearContext(); // clear the security context to remove authentication

        return buildUserResponse(null, null);
    }
